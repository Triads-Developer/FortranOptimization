...
!   xsec_width = 0.
   ...
   write (*,'(/a,21(/t3,a))') 'The commands are:',&
    'anno',&
    'bdps bias bloc bptc',&
    'cal  ccat cfil clim comm corr cptf ctyp cvff cvid cvtt',&
    ...
    'noxf nsmd',&
    'oldr',&
    'p_tt pert phid phrp phyp plot pltt ppri pttt',&
   ...
   do ! Loop for interactive commands
      ...
      if (comd .eq. 'anno') then
         ...
         call warnings ('mloc_main: "ifsm" is temporarily disabled for debugging')
...
block data mloc_init
   ...
   data version /'mloc v10.6.1, release date July 17, 2023'/
