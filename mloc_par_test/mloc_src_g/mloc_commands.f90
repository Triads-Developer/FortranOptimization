...
! COMCAT output file. This is a format designed especially for import into the USGS/NEIC "COMCAT" catalog server.
   ...
   if (command_help) then
      write (*,'(8(a/))')&
       ...
       'needed for uploading to the USGS/NEIC ComCat server. The same file is used in the GCCEL',&
       'project. The command takes a single optional',&
...
! Review of currently-selected parameters and options
   ...
   write (*,'(t3,a,t50,a,l1)') '(ccat) COMCAT file output', ': ', comcatout
...
! Plotting of cross-sections (depth profiles)
   ...
   if (command_help) then
      write (*,'(5(a/))')&
       '"xsec" controls the plotting of cross-sections through the hypocentroid.',&
