...
! New format for covariance matrix output, 2/3/05 by eab.
      ...
      integer :: ndatx, ndatp, ndats, ndatm, ndatt, ndatd
      real sumdx(4), sumdx0(4), sumdxp(4), nsvsprd, xsigma, hdh, cv1i, cv2i, dgkmlo, dcvi, dcvc, cv1f, cv2f, dcvf
      ...
      if (cv_perturb) write (io_out,'(a,f6.3)') ' Cluster vector inflation/deflation factor: ', perturbation
...
! Hypocentroid data
      ...
      write (io_out,'(/25x,a,8x,a,5x,a,7x,a,11x,a,3x,a)') 'TIME', 'LATITUDE', 'LONGITUDE', 'DEPTH', 'E**2/NSTA', 'SHAT'
      lon_test = lonh(0)
      ...
      do i = 0,it
         ...
         write (io_out,'(a,i2,20x,f6.2,a,3x,f6.2,a,5x,f6.2,a,4x,f7.2,a,2x,f8.1,a,i5,2x,f5.2)') ' ITER', i, delx0(4,i),&
