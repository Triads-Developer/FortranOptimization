...
! This version is modified to work with MNF v1.3.4 data files.

   implicit none

   integer, parameter :: line_max = 20000 ! Maximum number of lines in an MNF file
   integer :: iev, imnf0, nline, i, ios
   character(len=20) :: infile0
   character(len=5) :: stname0, stname
   character(len=8) :: phase0, phase, readsrc0, phase_new
   ...
   do
      ...
      if (buffer(imnf0)(5:9) .ne. stname0 .or.&
          ...
          buffer(imnf0)(109:113) .ne. readsrc0(1:5)) then
